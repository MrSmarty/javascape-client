...
// private ObservableList<String> observableElseCommands =
// FXCollections.observableArrayList();

// private ObservableList<String> observableConditions =
// FXCollections.observableArrayList();
...
// addCondition();
// });
// conditionBoxHeader.getChildren().addAll(new Label("Conditions:"),
// newCondition);
...
// addCommand();
// });
// elseCommandBoxHeader.getChildren().addAll(new Label("Commands:"),
// newElseCommand);

// elseCommandBox.getChildren().addAll(new Label("ELSE DO:"),
// elseCommandBoxHeader);
...
// ConditionalJob job = new ConditionalJob(nameField.textProperty().getValue(),
// commands, conditions);
...
// Scene s = new Scene(g);
// s.getStylesheets().add(getClass().getResource("/stylesheets/main-" +
// Settings.theme +".css").toExternalForm());
...
// Button add = new Button("Add");
// add.setOnAction(e -> {
// String condition = setReceiver.getValue().getUID() + ":" +
// setSensor.getValue().getIndex() + " "
